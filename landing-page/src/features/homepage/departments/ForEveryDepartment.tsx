...
const departments = [
  {
    ...
    sub: "Connect your bank accounts and sales tools to see your real-time cash position instantly.",
    bulletPoints: [
      {
        main: "Lead scoring",
        sub: "ProfitPilot asks questions while automatically scoring and prioritizing new leads.",
      },
      {
        main: "Insights",
  ...
  },
  {
    ...
    sub: "Automatically categorize spending and spot wasteful subscriptions before they drain your profits.",
    bulletPoints: [
      {
  ...
  },
  {
    ...
    sub: "Simulate future scenarios. Ask 'Can I afford this?' and get a data-backed answer in seconds.",
    bulletPoints: [
      {
    ...
    <>
      <div className="w-full gap-12 flex flex-col max-w-7xl">
        <div className="flex flex-col gap-4">
          <h2>Master Every Aspect of Your Business</h2>
          <p className="text-gray-11 font-normal">
            From tracking pennies to projecting millions, get the clarity you need to grow.
          </p>
        </div>
